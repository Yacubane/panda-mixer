        ...
        return (
            <SiteLayout className={styles.root}>
                ...
                >
                    ...
                    <div style={{"display": "flex", margin: "0.25em"}}>
                        <Input value={this.state.inputValueYT} onChange={this.updateInputValueYT}
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                <div style={{'margin-top': 'auto'}}>
                                                    <Button style={{width: "5em"}} type="primary" htmlType="submit"
                                                            onClick={() => this.handleAddToPlaylistClick(item.id)}>
                                                        Add
                                                    </Button>
                                                </div>
                                            </div>
                    ...
                    <div style={{"max-width": "100%"}}>
                        ...
                        <div style={{"text-align": "center"}}>
                            ...
                            <Button
                                ...
                                style={{width: "10em",}} className={styles.basicButton} icon="edit" type="round"
                                htmlType="submit">
                            ...
                            <Button
                                ...
                                style={{width: "10em",}} className={styles.basicButton} icon="eye" type="round"
                                htmlType="submit">
                        ...
                        <div>
                            ...
                            <MusicList ref={this.musicList} playlistId={this.props.match.params.id}
                                       showEditOptions={() => this.isEditableOrOwner()} onPlayClick={(order, id) => {
                                this.setState({lastVideoOrder: order});
                                this.YTPlayer.current.playVideo(id)
                            }}/>}
                        ...
                        <div>
                            <div style={{'text-align': 'center',}}>
                                ...
                                <Button
                                    ...
                                    className={styles.basicButton + ' ' + styles.addButton} icon="plus" type="round"
                                    htmlType="submit" onClick={this.handleAddClick.bind(this)}>
                                    Add
                                </Button>
                                }
                            </div>
